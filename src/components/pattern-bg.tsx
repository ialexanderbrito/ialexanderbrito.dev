...
const Dots = () => <rect x="0" y="0" width="4" height="4" className="text-muted-foreground" fill="currentColor" />;
...
export const PatternBackground = ({ variant }: PatternProps) => {
  ...
  return (
    <>
      <div className="absolute right-0 top-0 -z-40 h-screen w-screen bg-linear-to-b from-transparent to-background" />

      <svg className="absolute right-0 top-0 -z-50 h-screen w-screen opacity-10 dark:opacity-5" fill="none">
        <defs>
