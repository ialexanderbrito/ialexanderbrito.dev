      ...
      <Container>
        ...
        <Section>
          ...
          >
            ...
            Desenvolvedor front-end Web e Mobile, formado em Sistemas de Informação na Universidade Unigranrio.
          </Paragraph>
          <Paragraph>
            Atualmente trabalhando na <strong>IK Solution como desenvolvedor Front-end Pleno</strong> e estudando UI Designer pelo curso <strong>uiBoost</strong>.
          </Paragraph>
          <Paragraph>
            Nas horas vagas gosto de desenvolver aplicações, clonar apps que já estão no mercado para aperfeiçoar meus estudos e também focando os estudos na parte UI/UX Design.
          </Paragraph>
        </Section>
      </Container>
    )
